    ...
    return {
        ...
        "Dense Data": {
            ...
            "Large Grid": [
                ...
                { id: 108, symbol: 'BRK.B', name: 'Berkshire', sector: 'Fin', ind: 'Insure', cap: '780B', price: 360.00, chg: 1.50, chg_p: '0.4%', vol: '3M', avg_vol: '3M', pe: 18, eps: 15, beta: 0.8, div: '0.0%', high52: 375 },
...
try {
    ...
    console.log("JSON is valid. Length:", json.length);
} catch (e) {
